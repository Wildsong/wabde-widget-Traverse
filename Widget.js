...
//  07/05/2017 - Fixed problem with CSS that was interfering with the attribute table display. Also added the ability to 
//               toggle the infowindow/popup display, some users want to be able to click on control points or other geometry 
//               and get more information.
//  11/14/2017 - Tested with WAB 2.5. Updated default linesymbol drawing to a solid line as export/import as GeoJSON had 
//               issues with a short dash line.
//
///////////////////////////////////////////////////////////////////////////
    ...
    function(declare, _WidgetsInTemplateMixin, BaseWidget,
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            postCreate: function() {
				...
				this.own(on(this.chkAllowPopups, 'change', lang.hitch(this, this.toggleMapPopups)));
            ...
            drawTraverse: function() {
                ...
                line.setWidth(4);
                line.setStyle(CartographicLineSymbol.STYLE_SOLID);
			...
			toggleMapPopups: function() {
				if (this.chkAllowPopups.checked) {
